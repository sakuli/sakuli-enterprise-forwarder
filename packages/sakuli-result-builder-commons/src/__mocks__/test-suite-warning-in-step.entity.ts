...
export const TestSuite_WARNING_IN_STEP: TestContextEntity = createEntity('suite', {
    id: 'example_xfce',
    warningTime: 300,
    criticalTime: 400,
    startDate: new Date(1970, 0, 1, 10, 31, 0),
    endDate: new Date(1970, 0, 1, 10, 31, 44, 750)
}, [
    createEntity('case', {
        id: 'case1',
        warningTime: 20,
        criticalTime: 30,
        startDate: new Date(1970, 0, 1, 10, 31, 0),
        endDate: new Date(1970, 0, 1, 10, 31, 13, 830)
    }, [
        createEntity('step', {
            id: 'Test_Sahi_landing_page',
            warningTime: 5,
            startDate: new Date(1970, 0, 1, 10, 31, 0),
            endDate: new Date(1970, 0, 1, 10, 31, 1, 80)
        }),
        createEntity('step', {
            id: 'Calculation',
            warningTime: 10,
            startDate: new Date(1970, 0, 1, 10, 31, 0, 10),
            endDate: new Date(1970, 0, 1, 10, 31, 7, 140)
        }),
        createEntity('step', {
            id: 'Editor',
            warningTime: 10,
            startDate: new Date(1970, 0, 1, 10, 31, 0, 20),
            endDate: new Date(1970, 0, 1, 10, 31, 1, 550)
        })
    ]),
    createEntity('case', {
        id: 'case2',
