...
export const TestSuite_WARNING_IN_CASE = createEntity('suite', {
    id: 'example_xfce',
    warningTime: 300,
    criticalTime: 400,
    startDate: new Date(1970, 1, 1, 10, 34, 0),
    endDate: new Date(1970, 1, 1, 10, 34, 42, 840)
}, [
        createEntity('case', {
            id: 'case1',
            warningTime: 20,
            criticalTime: 30,
            startDate: new Date(1970, 1, 1, 10, 34, 0),
            endDate: new Date(1970, 1, 1, 10, 34, 14, 30)
        }, [
                createEntity('step', {
                ...
                createEntity('step', {
                    ...
                    endDate: new Date(1970, 1, 1, 10, 34, 7, 340)
                }),
                createEntity('step', {
                    id: 'Editor',
                    warningTime: 10,
                    startDate: new Date(1970, 1, 1, 10, 34, 0, 30),
                    endDate: new Date(1970, 1, 1, 10, 34, 1, 460)
                })
            ]),
        createEntity('case', {
            id: 'case2',
