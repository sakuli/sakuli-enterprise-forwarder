...
import {NagiosTestResultOutputBuilder} from "./index";
...
describe('suite templates', () => {
    ...
    let renderer: NagiosTestResultOutputBuilder;

    beforeEach(() => {
        ctx = new TestExecutionContext(new SimpleLogger);
        renderer = new NagiosTestResultOutputBuilder();
    });
