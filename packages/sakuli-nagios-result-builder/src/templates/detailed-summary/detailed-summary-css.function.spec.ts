import render from "./detailed-summary-css.function";

describe("detailed_summary_css", () => {
    it("should render CSS in a single line", () => {
        // GIVEN
